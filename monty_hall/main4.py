...
def create_result_image(is_car=True):
    ...
    if is_car:
        ...
        pygame.draw.circle(surface, BLACK, (50, 120), 15)
        pygame.draw.circle(surface, BLACK, (100, 120), 15)
    else:
...
def main():
    ...
    showMessage('Monty Hall Problem', display_width // 2 - 200, display_height // 2 - 50, 
               font_size=50, color=LIME)
    showMessage('蒙提霍尔问题', display_width // 2 - 120, display_height // 2, 
